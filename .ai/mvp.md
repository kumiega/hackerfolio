...
<project_description>
# Aplikacja - Hackerfolio (MVP)

## Główny problem
Stworzenie własnego profesjonalnego i dobrze zaprojektowanego portfolio potrafi być trudne i czasochłone. 
Zwłaszcza dla programistów, którzy nie mają kompetencji do tworzenia wizualnie przyjemnych aplikacji.

## Najmniejszy zestaw funkcjonalności
- Generowanie statycznej strony portfolio na subdomenie aplikacji
- Tworzenie, usuwanie i edycja sekcji portfolio
- Proste przechowywanie danych użytkownika  
- Generowanie sekcji za pomocą szablonu

## Co NIE wchodzi w zakres MVP
- Obsługa wielu szablonów (themes)
- Generowanie CV
- Możliwość dodania własnej domeny

## Kryteria sukcesu
- 90% Użytkowników generuje swoje portfolio 
